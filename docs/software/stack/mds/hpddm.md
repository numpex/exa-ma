...
* [x] A repository where anyone can submit a modification proposition (pull request)
  - https://github.com/hpdomain decomposition methods/hpdomain decomposition methods
...
* [ ] it uses codemeta format

## API compatibility information

* [ ] any API addition or breakage should be documented
* [ ] Semantic Versioning is used
* [ ] a policy easing predictability of these aspects for future release is provided
