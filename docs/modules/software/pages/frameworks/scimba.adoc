...
:description: Scimba - Scimba is a Python library that implements several Scientific Machine Learning (SciML) methods for PDE problems, as well as tools for hybrid numerical...
:icons: font
:page-work-packages: WP1, WP2, WP3, WP4, WP7
...
* https://gitlab.inria.fr/scimba/scimba/-/issues
____
====
--
...
=== WP1
Topics: finite element, unstructured mesh, finite volume
