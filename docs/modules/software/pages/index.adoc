...
[.lead]
Work Package 7 focuses on software development, benchmarking, co-design activities, and training material to deliver production-ready exascale software following the CI/CD framework proposed by Exa-DI.
...
link:https://numpex-pc5.gitlabpages.inria.fr/tutorials/projects/catalog/index.html[icon:external-link-alt[] NumPEx Software Catalog] provides the cross-project NumPEx software package catalog and complements the Exa-MA WP7 software stack pages below.
--
...
Working closely with Exa-DI project to ensure effective communication and synergy for advancements in exascale computing.
____
...
image::ROOT:wp7-workflow.png[role="img-fluid img-shadow img-rounded w-70 justify-self-center",alt="Exa-MA software development workflow"]
