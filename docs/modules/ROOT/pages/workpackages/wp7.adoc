...
[.lead]
WP7 integrates, tests, and benchmarks methods and software from all WPs, coordinates co-design activities with Exa-DI, and delivers the showroom, CI/CD infrastructure, and training materials.
...
* Coordination of co-design activities within Exa-MA and with Exa-DI
...
* **NumPEx Projects**: ExaSoft, ExaDoST, ExaAToW, Exa-DI (CI/CD and co-design)
